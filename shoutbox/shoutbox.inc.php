...
<td>
	...
	<td align="right"><input type="hidden" name="sbName" maxlength="20" class="cssShoutForm" value="<?php echo $GLOBALS['username'];?>"style="width:<?php echo round($boxWidth * 0.65); ?>px"></td>
	</tr><tr>
<?php
	if(!$hideEmail) {
?>
